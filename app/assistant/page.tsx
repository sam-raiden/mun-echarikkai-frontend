...
const uiText = {
  ...
  TA: {
    ...
    intro: 'பயிர், வானிலை, சந்தை குறித்து ஏதும் கேளுங்கள்.',
    play: 'குரல் ஒலி',
    playing: 'ஒலிக்கிறது',
    inputPlaceholder: 'தொடர்ந்து கேள்வி கேளுங்கள்...',
    diagnosis: 'நோய் கண்டறிதல்',
    weather: 'வானிலை தாக்கம்',
    treatment: 'சிகிச்சை',
    market: 'சந்தை தகவல்',
    diagnosisDesc: 'இலைகளில் ஊட்டச்சத்து குறைபாடு இருக்கலாம்.',
    treatmentDesc: 'நீம் தெளிப்பை வாரம் ஒருமுறை செய்யவும்.',
    weatherDesc: '5-7 நாட்களில் மழை வாய்ப்பு உள்ளது.',
    marketDesc: 'உங்கள் பகுதியில் தேவை அதிகரித்து வருகிறது.',
  },
} as const;
